        ...
        <div className="notif-dropdown">
          ...
          {items.map((it) => {
            ...
            return (
              ...
              >
                <div className="notif-item-title">{it.contact_name} <span className="notif-item-type">({it.type === 'hutang' ? t('hutangPiutang.typeHutang') : t('hutangPiutang.typePiutang')})</span></div>
