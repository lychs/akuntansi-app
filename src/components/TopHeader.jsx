...
import { LogOut, ChevronDown, PlusCircle, Pencil, Check, X, Sun, Moon, Menu, Building2, Users2, History } from 'lucide-react'
        ...
        <div className="user-menu" ref={menuRef}>
          ...
          {menuOpen && (
            <div className="user-menu-dropdown">
              ...
              <Link to="/perusahaan/profil" onClick={() => setMenuOpen(false)}>
                <Building2 size={15} /> {t('sidebar.companyProfile')}
              </Link>
              <Link to="/perusahaan/akses" onClick={() => setMenuOpen(false)}>
                <Users2 size={15} /> {t('sidebar.manageAccess')}
              </Link>
              <Link to="/perusahaan/audit-log" onClick={() => setMenuOpen(false)}>
                <History size={15} /> Riwayat Aktivitas
              </Link>
