...
import TransaksiBerulang from './pages/TransaksiBerulang.jsx'
import PenyesuaianOtomatis from './pages/PenyesuaianOtomatis.jsx'
...
import Bom from './pages/manufaktur/Bom.jsx'
import ProductionOrder from './pages/manufaktur/ProductionOrder.jsx'
import ProductionOrderDetail from './pages/manufaktur/ProductionOrderDetail.jsx'
import DashboardManufaktur from './pages/manufaktur/DashboardManufaktur.jsx'
import LaporanProduksi from './pages/manufaktur/LaporanProduksi.jsx'
import LaporanKonsumsiBahan from './pages/manufaktur/LaporanKonsumsiBahan.jsx'
import LaporanBiayaProduksi from './pages/manufaktur/LaporanBiayaProduksi.jsx'
import LaporanRejectScrap from './pages/manufaktur/LaporanRejectScrap.jsx'
import LaporanProfitabilitas from './pages/manufaktur/LaporanProfitabilitas.jsx'
import LaporanInventoriManufaktur from './pages/manufaktur/LaporanInventoriManufaktur.jsx'
import LaporanTenagaKerja from './pages/manufaktur/LaporanTenagaKerja.jsx'
import LandingPage from './pages/LandingPage.jsx'
import LandingFitur from './pages/LandingFitur.jsx'
import LandingHarga from './pages/LandingHarga.jsx'
import LandingTentang from './pages/LandingTentang.jsx'
import LandingSyarat from './pages/LandingSyarat.jsx'
import LandingPrivasi from './pages/LandingPrivasi.jsx'
...
function RequireAuth({ children }) {
  ...
  if (!session) {
    // Kalau lagi di halaman utama dan belum login, tampilkan landing page
    // (bukan langsung redirect ke /login) — semua path LAIN tetap redirect
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/harga" element={<LandingHarga />} />
      <Route path="/tentang" element={<LandingTentang />} />
      <Route path="/syarat-ketentuan" element={<LandingSyarat />} />
      <Route path="/kebijakan-privasi" element={<LandingPrivasi />} />
      <Route
        element={
          <RequireAuth>
            <Layout />
      ...
      >
        ...
        <Route path="/transaksi/berulang" element={<TransaksiBerulang />} />
        <Route path="/transaksi/penyesuaian-otomatis" element={<PenyesuaianOtomatis />} />
        ...
        <Route path="/perusahaan/audit-log" element={<AuditLog />} />
        ...
        <Route path="/manufaktur/bom" element={<Bom />} />
        <Route path="/manufaktur/production-order" element={<ProductionOrder />} />
        <Route path="/manufaktur/production-order/:id" element={<ProductionOrderDetail />} />
        <Route path="/manufaktur/dashboard" element={<DashboardManufaktur />} />
        <Route path="/manufaktur/laporan-produksi" element={<LaporanProduksi />} />
        <Route path="/manufaktur/laporan-konsumsi-bahan" element={<LaporanKonsumsiBahan />} />
        <Route path="/manufaktur/laporan-biaya" element={<LaporanBiayaProduksi />} />
        <Route path="/manufaktur/laporan-reject-scrap" element={<LaporanRejectScrap />} />
        <Route path="/manufaktur/laporan-profitabilitas" element={<LaporanProfitabilitas />} />
        <Route path="/manufaktur/laporan-inventori" element={<LaporanInventoriManufaktur />} />
        <Route path="/manufaktur/laporan-tenaga-kerja" element={<LaporanTenagaKerja />} />
      </Route>
    </Routes>
  )
}
