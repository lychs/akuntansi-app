...
export default function Login() {
  ...
  // Deteksi link konfirmasi email yang diklik dari email Supabase — biar user
  // gak cuma "dilempar" ke halaman login tanpa penjelasan, tapi lihat pesan
  // sukses dulu. Supabase nempelin info ini di hash URL (#access_token=...&type=signup)
  // atau kadang di query string (?type=signup / ?error=...).
  useEffect(() => {
    ...
    if (errorDescription) {
      ...
      setInfo(t('login.emailConfirmedSuccess'))
    }
    // Bersihin hash/query biar gak nyangkut kalau halaman di-refresh.
