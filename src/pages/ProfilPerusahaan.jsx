...
import DagangAccountSettings from '../components/DagangAccountSettings.jsx'
import ManufacturingAccountSettings from '../components/ManufacturingAccountSettings.jsx'
...
export default function ProfilPerusahaan() {
  ...
  return (
    <div className="p-6">
      ...
      <div className={(companyData.business_type === 'dagang' || companyData.business_type === 'manufaktur') ? 'profile-2col' : ''}>
        ...
        {companyData.business_type === 'dagang' && (
          <DagangAccountSettings companyId={activeCompanyId} initialData={companyData} onSaved={load} />
        )}
        {companyData.business_type === 'manufaktur' && (
          <ManufacturingAccountSettings companyId={activeCompanyId} initialData={companyData} onSaved={load} />
        )}
      </div>
    </div>
  )
