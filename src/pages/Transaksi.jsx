...
export default function Transaksi() {
  ...
  async function handleSubmit(e) {
    ...
    // Tetap di halaman ini (gak lompat ke Dashboard) — biar gampang input
    // transaksi berturut-turut. Reset field yang biasanya beda tiap transaksi,
    // tapi biarin Jenis/Cabang/Tanggal tetap (sering dipakai berulang).
    setDebitAccount('')
    setCreditAccount('')
    setNominal('')
    setNote('')
    ...
    <div className="p-6">
      ...
      <div className="txn-layout">
        ...
        <form className="txn-form-panel" onSubmit={handleSubmit}>
          ...
          {success && <p style={{ color: 'var(--positive)', fontSize: 13, fontWeight: 600 }}>{t('transaksi.savedSuccessStayHere')}</p>}
