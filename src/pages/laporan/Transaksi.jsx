...
import { Printer, Paperclip, Pencil, Trash2, Plus, Percent } from 'lucide-react'
...
export default function LaporanTransaksi() {
  ...
  async function handleDelete(t2) {
    ...
    const rpcName = HP_TYPES.includes(t2.type) ? 'delete_transaction_hutang_piutang' : 'delete_transaction_simple'
