...
export default function Aset() {
  ...
  async function load() {
    const { data, error } = await supabase
      .from('assets')
      .select('id, code, name, description, acquisition_date, acquisition_cost, depreciation_start_date, useful_life_months, salvage_value, depreciation_expense_account_id, accumulated_depreciation_account_id, accounts ( id, code, name )')
